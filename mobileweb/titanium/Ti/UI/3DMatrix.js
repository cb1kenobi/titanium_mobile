define(["Ti/_/declare", "Ti/_/Evented", "Ti/_/lang", "Ti/Platform"],
	...
	return api = declare("Ti.UI.3DMatrix", Evented, {
		...
		toArray: function() {
			return [this.a, this.b, this.c, this.d, this.tx, this.ty, this.rotation];
		},
		...
		toCSS: function() {
			...
			return "matrix3d(" + v.join(",") + ") rotate3d(" + this.rotation + "deg)";
		}
