			...
			if (fmt == 'xml') {
				...
				dom.create = function (tag, attrs, parent, callback) {
					...
					if (parent) {
						...
						if (parent.childNodes.length) {
							...
							if (p) {
								console.log(tag);
								parent.insertBefore(node, p.nextSibling);
								if (p.previousSibling && p.previousSibling.nodeType != ELEMENT_NODE) {
									parent.insertBefore(dom.createTextNode(p.previousSibling.data), p.nextSibling);
								}
								doAppend = false;
							}
						}
				...
				dom.updateOrCreate = function (tag, findAttrs, attrs, parent, callback) {
							...
							if (match) {
								...
								if (attrs) {
									Object.keys(attrs).forEach(function (a) {
										a != 'nodeValue' && child.setAttribute(a, attrs[a]);
									});
					...
					if (child) {
						...
						console.log('creating ' + tag, attrs);
