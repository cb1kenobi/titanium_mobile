...
(function () {
	var tiapp = new ti.tiappxml(__dirname + '/resources/tiapp1.xml');
...
(function () {
	...
	console.log('\nReading tiapp1.xml and modifying');
//	console.log('toString():')
//	console.log(tiapp.toString());
//	console.log('\nJSON:')
//	console.log(tiapp.toString('json'));
...
//	console.log('\nXML:');
	...
	tiapp.id = 'ti.testapp.rocks';
	tiapp.mobileweb.splash.enabled = false;
	tiapp.modules.push({
		id: 'new.module',
		platform: 'mobileweb',
		version: '1.0'
	...
	tiapp.ios || (tiapp.ios = {});
	tiapp.ios.enablecoverage = true;
	tiapp['deployment-targets'] || (tiapp['deployment-targets'] = {});
	tiapp['deployment-targets'].ipad = false;
	tiapp['deployment-targets'].blah = true;
	delete tiapp.mobileweb.theme;
